...
export const FeedbackSubmitted = ({
    ...
    return (
        <Html>
            <Head />
            <Preview>
                {respondentName} just submitted their responses to your "{surveyName}" survey! 📝
            </Preview>
            <Tailwind>
                <Body className="bg-white font-sans">
                    <Container className="mx-auto py-5 pb-12">
                        ...
                        <Text className="text-base">
                            {respondentName} has completed the survey titled "{surveyName}". You can review their responses and gather insights by clicking the button below.
                        </Text>
                        ...
                        <Text className="text-base">
                            Thanks for using Recognify to engage your team and drive meaningful feedback!
                        </Text>
