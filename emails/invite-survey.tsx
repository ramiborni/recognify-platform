        ...
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-5 pb-12">
            ...
            <Text className="text-base">
              {senderFullName} has created a survey for you. Your feedback is
              valuable, and we encourage you to participate by clicking the
              button below.
            </Text>
            ...
            <Text className="text-base">
              Thank you for contributing your thoughts and helping our team
              improve!
            </Text>
