...
export const AddedRecognition = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        {senderFullName} recognized you in a Recognition and awarded you{" "}
        ...
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-5 pb-12">
            ...
            <Text className="text-base">
              You&apos;ve been recognized by {senderFullName} for your amazing
              work and awarded {points} points! Check out the details of your
              recognition by clicking the button below.
            </Text>
            ...
            <Text className="text-base">
              Thanks for being an awesome part of the team and spreading
              positivity!
            </Text>
